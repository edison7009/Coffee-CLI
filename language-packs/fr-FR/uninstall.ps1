# Coffee CLI Language Pack Uninstaller — Français
# Usage: iwr -useb https://raw.githubusercontent.com/edison7009/Coffee-CLI/main/language-packs/fr-FR/uninstall.ps1 | iex
