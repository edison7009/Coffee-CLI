# Coffee CLI Language Pack Uninstaller — 한국어
# Usage: iwr -useb https://raw.githubusercontent.com/edison7009/Coffee-CLI/main/language-packs/ko-KR/uninstall.ps1 | iex
