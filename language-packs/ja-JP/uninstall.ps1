# Coffee CLI Language Pack Uninstaller — 日本語
# Usage: iwr -useb https://raw.githubusercontent.com/edison7009/Coffee-CLI/main/language-packs/ja-JP/uninstall.ps1 | iex
