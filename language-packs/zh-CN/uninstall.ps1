# Coffee CLI Language Pack Uninstaller — 简体中文
# Usage: iwr -useb https://raw.githubusercontent.com/edison7009/Coffee-CLI/main/language-packs/zh-CN/uninstall.ps1 | iex
