...
| Feature | Description |
|---|---|
| **Real-Time Translation** | CLI agent output translated into your language as it streams — commands, responses, errors, all of it |
| **Multi-Tab Sessions** | Run multiple agents side by side, each with its own process and translation context |
...
**实时终端翻译** · **多 Tab 会话** · **会话历史** · **内置文件浏览器** · **任务板** · **Agent 安装器** · **远程终端**
