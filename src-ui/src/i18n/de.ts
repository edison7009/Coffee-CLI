export const de = {
  ...
  'hyper_agent.first_time_hint': 'Zum ersten Mal hier? Füge die folgende Regel in OpenClaw / Hermes Agent ein, damit sie wissen, wie man über Panes hinweg arbeitet:',
