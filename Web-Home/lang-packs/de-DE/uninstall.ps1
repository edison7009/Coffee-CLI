# Coffee CLI Language Pack Uninstaller — Deutsch
# Usage: iwr -useb https://raw.githubusercontent.com/edison7009/Coffee-CLI/main/language-packs/de-DE/uninstall.ps1 | iex
