# Coffee CLI Language Pack Uninstaller — Tiếng Việt
# Usage: iwr -useb https://raw.githubusercontent.com/edison7009/Coffee-CLI/main/language-packs/vi-VN/uninstall.ps1 | iex
