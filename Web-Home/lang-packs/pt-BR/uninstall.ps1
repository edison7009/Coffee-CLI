# Coffee CLI Language Pack Uninstaller — Português (BR)
# Usage: iwr -useb https://raw.githubusercontent.com/edison7009/Coffee-CLI/main/language-packs/pt-BR/uninstall.ps1 | iex
